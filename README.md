...
(standard library only — no `pip install`) covering **the full public Explorer surface** —
accounts, assets, ledgers, transactions, trades, price candles, markets, liquidity pools,
offers, Soroban contracts (including WASM download), the directory, and a ledger stream.
If you have Python 3.9+ on your PATH, it just works.
